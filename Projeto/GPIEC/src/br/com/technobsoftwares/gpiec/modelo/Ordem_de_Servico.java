...
public class Ordem_de_Servico {
    ...
    private String comentarios_fechamento;

    public String getComentarios_fechamento() {
        return comentarios_fechamento;
    }

    public void setComentarios_fechamento(String comentarios_fechamento) {
        this.comentarios_fechamento = comentarios_fechamento;
    }
