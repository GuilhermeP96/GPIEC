 ...
 * @author User
 */
public class FrmInMinhasOS extends javax.swing.JInternalFrame {
    /**
     * Creates new form FrmInFechaOS
     */
    public FrmInMinhasOS() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Painel.setBorder(javax.swing.BorderFactory.createTitledBorder("Ordens de Serviço já abertas"));
        ...
        tbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Serviço", "Titulo", "Status", "Local", "Computador", "Data de Abertura", "Descrição", "Data de Fechamento"
            }
        ) {
    ...
    private void tblAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_tblAncestorAdded
        Ordem_de_ServicoDAO dao = new Ordem_de_ServicoDAO();
        List<Ordem_de_Servico> oss = dao.getLista();
    ...
    private void CaracteresConsulta(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CaracteresConsulta
    ...
    }//GEN-LAST:event_CaracteresConsulta
