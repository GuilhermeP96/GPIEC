...
import br.com.technobsoftwares.gpiec.dao.ComputadorDAO;
import br.com.technobsoftwares.gpiec.dao.LocalDAO;
import br.com.technobsoftwares.gpiec.dao.Ordem_de_ServicoDAO;
import br.com.technobsoftwares.gpiec.dao.Tipo_ProblemaDAO;
...
public class FrmInAbreOS extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cmbComp.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "*COMPUTADOR*" }));
        ...
        jPanel1.add(cmbComp, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 120, 140, 30));
    ...
    private void cmbLocalItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbLocalItemStateChanged
        if (cmbLocal.getSelectedIndex()!= 0) {
            ...
            Ordem_de_ServicoDAO os = new Ordem_de_ServicoDAO();
    ...
    private void cmbServiçoAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_cmbServiçoAncestorAdded
        Tipo_ProblemaDAO dao = new Tipo_ProblemaDAO();
        List<Tipo_Problema> tproblemas = dao.getLista();
        DefaultComboBoxModel model = (DefaultComboBoxModel) cmbServiço.getModel();
        for (Tipo_Problema tproblema : tproblemas) {
    ...
    private void cmbCompAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_cmbCompAncestorAdded
       ...
       List<Computador> computadores = dao.getLista();
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        ...
        if ((cmbComp.getSelectedIndex() != 0) && (cmbLocal.getSelectedIndex() != 0) && 
                (cmbServiço.getSelectedIndex() != 0) && (!"".equals(txtJustif.getText())) && 
                    (!"".equals(txtaDesc.getText()))) {
            ...
            os.setFk_id_tipo_problema(cmbServiço.getSelectedIndex());
