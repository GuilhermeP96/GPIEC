...
public class FrmInConsUser extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cmbMetodo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Código", "Nome", "Sobrenome", "Login", "Grupo" }));
        jPanel1.add(cmbMetodo, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 30, -1, 30));
        ...
        jPanel1.add(btnCanc, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 380, -1, 30));
        ...
        jPanel1.add(btnExc, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 380, -1, 30));
        ...
        jPanel1.add(btnLimpar, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 190, -1, 30));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 1120, 650));
...
//            fmtConsData.setVisible(false);
            ...
            btnCons.setLocation(390, 30);
            txtCons.setSize(80, 30);
//            txtCons.setVisible(true);
//            fmtConsData.setVisible(false);
        }
            ...
            btnCons.setLocation(390, 30);
            txtCons.setSize(80, 30);
            lblMetodo.setLocation(200, 40);
//            lblMetodo.setText("Data de Entrada:");
//            fmtConsData.setLocation(340, 30);
//            btnCons.setLocation(450, 30);
...
//            txtCons.setVisible(true);
    ...
    private void btnConAltActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConAltActionPerformed
        ...
        if ((alteracao == true) && (cmbGrupo.getSelectedIndex() != 0) && ("11".equals(testeddd))) {
    ...
    private void TeclaPressionadaConsulta(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TeclaPressionadaConsulta
    ...
    }//GEN-LAST:event_TeclaPressionadaConsulta
    ...
    private void btnConsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "Insira um ID válido!"+e);
            txtCons.requestFocus();
        }
    ...
    private void cmbGrupoAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_cmbGrupoAncestorAdded
        ...
        List<Tipo_Usuario> tipo_usuarios = dao.getLista();
        DefaultComboBoxModel model = (DefaultComboBoxModel) cmbGrupo.getModel();
        for (Tipo_Usuario tipo_usuario : tipo_usuarios) {
