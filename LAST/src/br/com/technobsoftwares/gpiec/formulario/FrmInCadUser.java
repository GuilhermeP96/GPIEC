    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try {
            if ((!"".equals(txtNome.getText())) && (!"".equals(txtSobren.getText())) &&
                ...
                (!"".equals(txtLogin.getText())) && (!"".equals(psrSenha.getText())) && (teste > 10) &&
                (cmbTipoUser.getSelectedIndex() != 0) && (teste <= 19)) {
...
//                usuario.setFk_tipo_user(UsuarioDAO.teste_id_tuser);
                usuario.setFk_tipo_user(cmbTipoUser.getSelectedIndex());
                ...
                JOptionPane.showMessageDialog(null, "Preencha todos os campos e selecione as opções!");
                txtNome.requestFocus();
            }
        } catch (Exception e) {
            txtNome.setText("");
...
//        nometipouser = String.valueOf(cmbTipoUser.getSelectedItem());
//        UsuarioDAO dao = new UsuarioDAO();
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER){
            try {
                if ((!"".equals(txtNome.getText())) && (!"".equals(txtSobren.getText())) &&
                    (!"   .   .   -  ".equals(fmtxtCpf.getText())) && (!"".equals(txtEmail.getText())) &&
                    (psrConSenha.getText().equals(psrSenha.getText())) && (!"(  )    -    ".equals(fmtxtTel.getText())) &&
                    (!"".equals(txtLogin.getText())) && (!"".equals(psrSenha.getText())) && ("11".equals(testeddd)) &&
